...
//3789, 3790, 3792, 3794, 3801, 3803, 3804, 3805
...
export async function consultarCedula(codigoPaquete, identificacion) {
  console.log(codigoPaquete, identificacion);
  ...
  try {
    ...
    return { message: "No se pudo consultar el CEDULA: " + error.message };
  }
}
